...
-- Volcando estructura de base de datos para curso_golang_next_db
CREATE DATABASE IF NOT EXISTS `golang_next_ecommerce_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `golang_next_ecommerce_db`;

-- Volcando estructura para tabla golang_next_ecommerce_db.addresses
...
-- Volcando estructura para tabla golang_next_ecommerce_db.category
...
-- Volcando estructura para tabla golang_next_ecommerce_db.orders
...
-- Volcando estructura para tabla golang_next_ecommerce_db.orders_detail
...
-- Volcando estructura para tabla golang_next_ecommerce_db.products
...
-- Volcando estructura para tabla golang_next_ecommerce_db.users
